...
import { signInSuccess,signInStart,signInFailure } from '../redux/user/slice';
      ...
      <div className='flex p-3 max-w-3xl mx-auto flex-col md:flex-row md:items-center gap-3'>
        ...
        <div className='flex-1'>
          ...
          <p className='text-sm mt-5'>
            Signin using your email or google account
          </p>
        </div>
        {/* right */}
        <div className='flex-1'>
          <form className='flex flex-col gap-4' onSubmit={handleSubmit} >
            ...
            <div>
              ...
              <TextInput
                type='email'
                placeholder='Email'
                id='email' onChange={handlleChange} />
            </div>
            <div>
              ...
              <TextInput
                type='password'
                placeholder='************'
                id='password' onChange={handlleChange} />
            </div>
